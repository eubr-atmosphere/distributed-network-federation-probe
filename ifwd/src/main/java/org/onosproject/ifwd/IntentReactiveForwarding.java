...
public class IntentReactiveForwarding {
    ...
    private class ReactivePacketProcessor implements PacketProcessor {
        ...
        public void process(PacketContext context) {
            ...
            if (ethPkt.getVlanID() != Ethernet.VLAN_UNTAGGED) {
                srcId = HostId.hostId(ethPkt.getSourceMAC(), VlanId.vlanId(ethPkt.getVlanID()));
                dstId = HostId.hostId(ethPkt.getDestinationMAC(), VlanId.vlanId(ethPkt.getVlanID()));
                selector = DefaultTrafficSelector.builder()
                        .matchVlanId(VlanId.vlanId(ethPkt.getVlanID()))
            ...
            setUpConnectivity(context, srcId, dstId, selector);
    ...
    private void setUpConnectivity(PacketContext context, HostId srcId,
                                   HostId dstId, TrafficSelector selectorSrcDst) {
        ...
        submitIntent(context, srcId, dstId, selectorSrcDst, treatment, keySrcDst, intentSrcDst,
                     filteredIngressCP, filteredEgressCP);
    }

    private void submitIntent(PacketContext context, HostId srcId, HostId dstId,
